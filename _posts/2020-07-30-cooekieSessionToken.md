...
![img](https://raw.githubusercontent.com/SensationG/images/master/note/20200730180650.png)

后来有个叫Memcached的支了招：把session id 集中存储到一个地方， 所有的机器都来访问这个地方的数据， 这样一来，就不用复制了， 但是增加了单点失败的可能性， 要是那个负责session 的机器挂了， 所有人都得重新登录一遍， 估计得被人骂死。

![img](https://raw.githubusercontent.com/SensationG/images/master/note/20200730180658.png)
...
![img](https://raw.githubusercontent.com/SensationG/images/master/note/20200730180734.png)

这个token 我不保存， 当小F把这个token 给我发过来的时候，我再用同样的HMAC-SHA256 算法和同样的密钥，对数据再计算一次签名， 和token 中的签名做个比较， 如果相同， 我就知道小F已经登录过了，并且可以直接取到小F的user id , 如果不相同， 数据部分肯定被人篡改过， 我就告诉发送者：对不起，没有认证。

![img](https://raw.githubusercontent.com/SensationG/images/master/note/20200730180741.png)

Token 中的数据是明文保存的（虽然我会用Base64做下编码， 但那不是加密）， 还是可以被别人看到的， 所以我不能在其中保存像密码这样的敏感信息。

当然， 如果一个人的token 被别人偷走了， 那我也没办法， 我也会认为小偷就是合法用户， 这其实和一个人的session id 被别人偷走是一样的。

这样一来， 我就不保存session id 了， 我只是生成token , 然后验证token ， 我用我的CPU计算时间获取了我的[session](http://mp.weixin.qq.com/s?__biz=MzU2MTI4MjI0MQ==&mid=2247483968&idx=1&sn=8f516e2f35cd658e9b5eafc395b4d629&chksm=fc7a6feecb0de6f8fd99417c0d4098d26ec9b00346c94a5e438525fc5a9f05441c42be7815cb&scene=21#wechat_redirect) 存储空间 ！
...
![img](https://raw.githubusercontent.com/SensationG/images/master/note/20200730180749.jpeg)
